...
class edit_Cart extends StatefulWidget {
  const edit_Cart({super.key});

  @override
  State<edit_Cart> createState() => _edit_CartState();
}

class _edit_CartState extends State<edit_Cart> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: FoodItemCard(title: 'Pizza Calzone', subtitle: 'European', price: '\$64', size: "14'’", quantity: '2'),
            ),
            Padding(
