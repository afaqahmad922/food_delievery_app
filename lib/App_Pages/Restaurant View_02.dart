...
class resturant_View_02 extends StatefulWidget {
  const resturant_View_02({super.key});

  @override
  State<resturant_View_02> createState() => _resturant_View_02State();
}

class _resturant_View_02State extends State<resturant_View_02> {
  @override
                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            padding: EdgeInsets.only(top: 20.h, left: 17.w, right: 18.w, bottom: 20.h),
                            child: Icon(Icons.menu, size: 15, color: Color(0xffFF8400)),
                          ),
                        ),
                      ],
                    ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        SliderDot(height: 8.h, width: 8.w, color: Color(0xffD9D9D9)),
                        SizedBox(width: 6.w),
                        SliderDot(height: 8.h, width: 8.w, color: Color(0xffD9D9D9)),
                        SizedBox(width: 6.w),
                        SliderDot(height: 12.h, width: 12.w, color: Colors.white),
                        SizedBox(width: 6.w),
                        SliderDot(height: 8.h, width: 8.w, color: Color(0xffD9D9D9)),
                        SizedBox(width: 6.w),
                        SliderDot(height: 8.h, width: 8.w, color: Color(0xffD9D9D9)),
